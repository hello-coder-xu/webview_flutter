...
- (void)onPageJumpURL:(NSString *)url{
    [_methodChannel invokeMethod:@"onPageJumpURL" arguments:@{@"url" : url}];
}

- (void)onPageChangeTitle:(NSString * )title{
    [_methodChannel invokeMethod:@"onPageChangeTitle" arguments:@{@"title" : title}];
}
