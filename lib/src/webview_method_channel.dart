...
class MethodChannelWebViewPlatform implements WebViewPlatformController {
  ...
  Future<bool> _onMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case 'onPageStarted':
        ...
        return null;
      case 'onPageJumpURL':
        _platformCallbacksHandler.onPageJumpURL(call.arguments['url']);
        return null;
      case 'onPageChangeTitle':
        _platformCallbacksHandler.onPageChangeTitle(call.arguments['title']);
        return null;
  ...
  @override
  Future<void> updateCookies(List<Map<String, String>> list) {
    if (list == null) return null;
    return _channel.invokeMethod<void>("updateCookies", list);
  }
