...
/// Signature for when a [WebView] has finished loading a page.
typedef void PageJumpURLCallback(String url);

/// Signature for when a [WebView] has finished loading a page.
typedef void PageTitleChangeCallback(String url);
...
class WebView extends StatefulWidget {
  ...
  final PageJumpURLCallback onPageJumpUrl;

  final PageTitleChangeCallback onPageChangeTitle;
  ...
  /// set cookies
  final List<Map<String, Object>> cookie;
...
class _PlatformCallbacksHandler implements WebViewPlatformCallbacksHandler {
  ...
  @override
  void onPageJumpURL(String url) {
    if (_widget.onPageJumpUrl != null) {
      _widget.onPageJumpUrl(url);
    }
  }

  @override
  void onPageChangeTitle(String title) {
    if (_widget.onPageChangeTitle != null) {
      _widget.onPageChangeTitle(title);
    }
  }
}
...
class WebViewController {
  ...
  ///upload cookies
  Future<void> uploadCookies(List<Map<String, String>> list) async {
    return _webViewPlatformController.updateCookies(list);
  }
